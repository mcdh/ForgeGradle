...
public final class UserConstants
{
   ...
   public static final String        FORGE_JAVADOC_URL     = Constants.FORGE_MAVEN + "/net/minecraftforge/forge/{API_VERSION}/forge-{API_VERSION}-javadoc.zip";

   public static final String        NATIVES_DIR_OLD       = "{BUILD_DIR}/natives";
   public static final String        SOURCES_DIR           = "{BUILD_DIR}/sources";

   public static final String        CONF_DIR              = "{USER_DEV}/conf";
   public static final String        MERGE_CFG             = CONF_DIR + "/mcp_merge.cfg";
   public static final String        MCP_PATCH_DIR         = CONF_DIR + "/minecraft_ff";
   ...
   public static final String        EXC_JSON              = CONF_DIR + "/exceptor.json";
   ...
   public static final String        DIRTY_DIR             = "{BUILD_DIR}/dirtyArtifacts";

   public static final String        RECOMP_SRC_DIR        = "{BUILD_DIR}/tmp/recompSrc";
   public static final String        RECOMP_CLS_DIR        = "{BUILD_DIR}/tmp/recompCls";
